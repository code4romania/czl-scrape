...
/**
 * Contract for an authentication strategy.
 *
...
public interface AuthenticationStrategy {
  ...
  /**
   * Processes the request with the goal of applying the authentication strategy. This is called before the request is executed.
   *
