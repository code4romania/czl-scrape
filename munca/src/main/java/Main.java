    ...
    if (info != null) {
      ...
      if ((adr.contains("http://www.mmuncii.ro/j33/index.php/ro/transparenta/proiecte-in-dezbatere/4") && depth != 0)) {
        ...
        try {
          ...
          while (it.hasNext()) {
            element = it.next();
            if (element.attr("abs:href").contains("Transparenta-decizionala") || element.attr("abs:href")
                .contains("http://www.mmuncii.ro/j33/images/Documente/Proiecte_in_dezbatere/2017/") || element.attr("abs:href")
                    .contains("http://www.mmuncii.ro/j33/images/Documente/Proiecte_in_dezbatere/2016/")) {
              if (thePdf == null) {
                ...
                } else if (element.text().startsWith("Hotărâre") || element.text().startsWith("HOTĂRÂRE")) {
                  type0 = "HG";
                  type1 = "Hotarare";
                }
                ...
                if (element.text().contains("Notă") || element.text().contains("notă")) {
                  type2 = "Nota";
                } else if (element.text().startsWith("Expunere") || element.text().startsWith("expunere")) {
                  type2 = "Expunere";
                }
