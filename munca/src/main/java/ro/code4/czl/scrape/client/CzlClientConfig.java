...
public class CzlClientConfig {
  ...
  /**
   * Returns the global ro.code4.czl.scrape.client.authentication strategy to be used by the client.
   *
  ...
  /**
   * Sets a global ro.code4.czl.scrape.client.authentication strategy to be used by the client.
   *
  ...
  public interface Build {
    ...
    /**
     * Sets the global ro.code4.czl.scrape.client.authentication strategy to be used by the client.
     *
     * @param authenticationStrategy an {@linkplain AuthenticationStrategy} instance
     */
